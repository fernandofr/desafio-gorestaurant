...
Nesse desafio, foi desenvolvido o GoRestaurant. Para praticar o que foi aprendido até aqui com React.js junto com TypeScript, praticando o conceito de CRUD (Create, Read, Update, Delete).
